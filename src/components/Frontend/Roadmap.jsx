...
function Roadmap() {
  return (
    <section id="roadmap" className="nft-faq-video-section">
        <div className="container">
            <div className="nft-faq-video-content">
                <div className="nft-section-title  nft-headline pera-content">
                    <h2>Roadmap. <span className="right-icon"><img src="assets/img/nft/icon/title-icon4.png" alt="" /></span></h2>
                </div>
                <div className="row">
                                    ...
                                    <div className="nft-faq">
                                        ...
                                        <div id="collapseOne" className="collapse show" data-parent="#accordionExample">
                                           ...
                                           <p>- V1 Stoked Kidz public sale is live</p>
                                            ...
                                            <p>- Once-a-week raffle draws in our discord where community members holding our NFT stand a chance to win different prizes.</p>

                                            <p>- launch of the 1st Stoked Kidz crate subscriptions. Lucky community members get exclusive crates with varied rewards.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="nft-faq">
                                        ...
                                        <div id="collapsetwo" className="collapse" data-parent="#accordionExample">
                                            <div className="nft-faq-body">
                                                <p>- Intensified marketing, including reaching out to prominent fashion brands for collaborations.</p>

                                                <p>- Merch Store to open for Stoked Kidz holders.</p>

                                                <p>- Development of our game.</p>

                                                <p>- Hiring within the community for various positions.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="nft-faq">
                                        <div className="nft-faq-header" id="headingthree">
                                            ...
                                            <button className="collapsed" data-toggle="collapse" data-target="#collapsethree" aria-controls="collapsethree">
                                                Beta Game Deployment/Testing, V2 Airdrop & Clothing line
                                            </button>
                                        </div>
                                        <div id="collapsethree" className="collapse" data-parent="#accordionExample">
                                            <div className="nft-faq-body">
                                                <p>- Game developed and prototype ready for beta testing.</p>

                                                <p>- Beta testing period ( with rewards for beta testers).</p>
                    ...
                    <div className="col-lg-6">
                        <div className="nft-video-play-area">
                            <div className="nft-video-play-img">
                                <img src="assets/img/nft/banner/video.png" alt="roadmap image" />
                            </div>
                            <div className="nft-video-play-btn">
                                <a className="d-flex justify-content-center align-items-center lightbox-image" href="https://www.youtube.com/watch?v=NNQLJcJEzv0"><i className="fas fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
