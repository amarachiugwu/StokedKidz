        ...
        <div className="container">
            <div className="nft-main-navigation-wrapper d-flex justify-content-between position-relative">
                <div className="nft-brand-logo">
                    <Link to="nft-banner"><img src="assets/img/nft/logo/logo.png" alt="Logo" /></Link>
                </div>
                <div className="nft-navigation-menu d-flex align-items-center">
                    <nav className="nft-main-navigation  clearfix ul-li">
                        <ul id="nft-main-nav" className="nav navbar-nav clearfix">
                            <li> <Link className="nav-link" to="#nft-banner">Home</Link></li>
                            <li> <Link className="nav-link" to="#nft-gallery">Nft Gallery</Link></li>
                            <li> <Link className="nav-link" to="#nft-top-creator">Creator</Link></li>
                            <li> <Link className="nav-link" to="#nft-faq-video">FAQ</Link></li>
                            <li> <Link className="nav-link" to="#nft-live-bid">Live Bid</Link></li>
                            <li> <Link className="nav-link" to="#nft-blog">Blog</Link></li>
                        </ul>
                    </nav>
                    <div className="nft-btn text-center">
                        <Link className="d-flex justify-content-center align-items-center" to="#"><img src="assets/img/nft/icon/ic1.png" alt="wallet" />Connect Wallet</Link>
                    </div>
                </div>
            </div>
