    ...
    <section id="nft-live-bid" class="nft-live-bid-section">
      <div class="container">
        <div class="nft-section-title text-center  nft-headline pera-content">
          <h2>
            ...
            <span class="right-icon">
              <img
                src="assets/img/nft/icon/title-icon4.png"
                alt="about image"
              />
            </span>
          </h2>
        ...
        <div class="nft-live-bid-content position-relative">
          <span class="nft-shape1 position-absolute">
            <img src="assets/img/nft/shape/cir2.png" alt="about image" />
          </span>
          <span class="nft-shape2 position-absolute">
            <img src="assets/img/nft/shape/sh3.png" alt="about image" />
          </span>
              ...
              <div class="thx-inner-item nft-headline">
                <div class="thx-inner-title-text d-flex justify-content-between">
                  <div class="thx-inner-title">
                    <h3>
                      <a href="#">Diamond Horses Art #57</a>
                    </h3>
                  </div>
                ...
                <div class="thx-inner-author d-flex align-items-center">
                  <div class="author-img">
                    <img
                      src="assets/img/nft/creator/bid-ath.png"
                      alt="about image"
                    />
                  </div>
                ...
                <div class="thx-inner-countdown">
                  ...
                  <div class="coming-countdown ul-li">
                    <ul
                      class="countdown_timer clearfix"
                      data-countdown="2022/8/24"
                    ></ul>
                  </div>
                </div>
