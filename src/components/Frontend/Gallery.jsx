...
function Gallery() {
  return (
    <section
      id="nft-gallery"
      className="nft-market-place-section position-relative"
    >
      <span className="nft-shape1 position-absolute">
        <img src="assets/img/nft/shape/sh1.png" alt="NFT image" />
      </span>
      <div className="container">
        <div className="nft-section-title text-center nft-headline pera-content">
          <h2>
            ...
            <span className="right-icon">
              <img src="assets/img/nft/icon/title-icon1.png" alt="NFT image" />
            </span>
          </h2>
        </div>
        <div className="nft-market-place-content">
          <div className="nft-marketplace-filter-btn-area text-center">
            <div className="nft-marketplace-filter-btn ul-li text-center">
              <ul id="filters" className="nav-gallery">
                <li className="filtr-button filtr-active" data-filter="all">
                  All
                </li>
                <li className="filtr-button" data-filter="1">
                  Scattered Hair
                </li>
                <li className="filtr-button" data-filter="2">
                  Bulgy Eyes
                </li>
                <li className="filtr-button" data-filter="3">
                  Angry
                </li>
                <li className="filtr-button" data-filter="4">
                  Happy
                </li>
              </ul>
            </div>
          ...
          <div className="nft-marketplace-item-wrapper filtr-container row">
            <div
              className="col-lg-3 col-sm-6 filtr-item"
              data-category="1, 2,4"
